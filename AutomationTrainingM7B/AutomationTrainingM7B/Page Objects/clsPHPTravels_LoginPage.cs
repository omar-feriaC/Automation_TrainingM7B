...
namespace AutomationTrainingM7B.Page_Objects
{
    class clsPHPTravels_LoginPage : BaseTest
    {
        ...
        public static void fnSideMenuBtn(string strMenuString)
        {
            ...
            _driverWait.Until(ExpectedConditions.ElementIsVisible(By.XPath("//ul[@class='wow fadeIn animated list-unstyled collapse in']//li[4]")));
            _driverWait.Until(ExpectedConditions.ElementExists(By.XPath("//ul[@class='wow fadeIn animated list-unstyled collapse in']//li[4]")));


            for (int a = 0; a < listSideSubMenu.Count; a++)
            {
                _driverWait.Until(ExpectedConditions.ElementIsVisible(By.XPath("//ul[@class='wow fadeIn animated list-unstyled collapse in']//li[4]")));
                _driverWait.Until(ExpectedConditions.ElementExists(By.XPath("//ul[@class='wow fadeIn animated list-unstyled collapse in']//li[4]")));

                objRM.fnAddStepLog(objTest, "Click on SubMenu: " + listSideSubMenu[a].Text, "PASS");
                listSideSubMenu[a].Click();
